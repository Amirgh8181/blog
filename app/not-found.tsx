  ...
  return (
    <div className='flex flex-col items-center w-full min-h-screen md:space-y-4 space-y-2 pt-4'>
      <h1 className='md:text-7xl text-2xl'>
        <TextAnimation title='404 page-not-found' staggerTime={0.1}/>
      </h1>
      <Image src={'/images/not-found.gif'} quality={100} priority={true} alt='error bg' width={800} height={800} className='w-[70vw] h-[60vh]' />
      <div>
        <Link
          href={'/'}
